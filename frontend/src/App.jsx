...
const AgentPage = () => (
    <div className="flex flex-col h-full bg-white dark:bg-slate-900 rounded-3xl shadow-xl overflow-hidden border border-slate-200 dark:border-slate-800 transition-colors">
        <div className="flex-1 flex justify-center min-h-0 bg-slate-50 dark:bg-slate-950">
            <div className="w-full h-full max-w-7xl flex flex-col bg-white dark:bg-slate-900">
